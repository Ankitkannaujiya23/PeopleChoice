...
const AdminHomePage = () => {
  ...
  useEffect(() => {
    ...
    const getAllPost = async () => {
      ...
      response = await fetchAllPost('blogPostController/fetchAllPost', `${category !== null ? category : ''}`, token);
      ...
      <section className='banner relative'>
        ...
        <div className='categorySection m-auto  flex justify-center'>
          <div className="menuHeading w-52  absolute -m-8">
            <h1 className='text-2xl text-white bg-gray-900 text-center'>Category Filter</h1>
          </div>
