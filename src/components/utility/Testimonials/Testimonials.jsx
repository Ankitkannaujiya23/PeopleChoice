            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto lg:px-44 overflow-hidden">
                    ...
                    <div className="slidershow flex justify-between mt-12">
                        <div className=""><div className="p-2 rounded-full bg-red-500"></div></div>
                        <div className="slide-button flex space-x-4">
                            <div className='p-4 outline outline-1 rounded-full cursor-pointer text-[#f53855] hover:text-white hover:bg-[#f53855] ' onClick={slideNext}> <BsArrowLeft className=' text-2xl  '  /></div>
                            <div className='p-4 outline outline-1 rounded-full cursor-pointer text-[#f53855] hover:text-white hover:bg-[#f53855] ' onClick={slidPrev}> <BsArrowRight className=' text-2xl  ' /></div>
                        </div>
                    </div>
                </div>
            </section>
